...
- current statistics: 4197000 (4.50 M) events (1000 events per final merged ROOT file)
- the output files for this production are in:
	- /scratch4/abilandz/sim/EPOS_20250416-1 => 2.31 M events (local, cluster "ktacluster", partition "kta") &mdash; **RUNNING**
	- /scratch6/abilandz/sim/EPOS_20250416-2 => 2.20 M events (GSI, cluster "Virgo", partition "main") &mdash; **RUNNING** 
