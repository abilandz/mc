...
- ALICE acceptance is NOT hardwired
- fillTree(C2) ('bim' variable = number of pomerons)
- total statistics: ~330 M events (~1 M events per final merged ROOT file) &mdash; __RUNNING__
- output files for this production are in:
  ...
  - /scratch3/abilandz/sim/EPOS_20220510-7 => 30 M events &mdash; __RUNNING__
