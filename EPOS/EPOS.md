...
- ALICE acceptance is NOT hardwired
- fillTree(C2) ('bim' variable = number of pomerons)
- total statistics: 8.2 M events (100 K events per final ROOT file) — **RUNNING**
- output files for this production are in:
  - /scratch5/abilandz/sim/EPOS_20201113-2 => 6.60 M events (local, cluster "ktacluster", partition "kta", using new EPOS 3.117 build from 2025) — **RUNNING**
