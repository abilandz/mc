...
- ALICE acceptance is NOT hardwired
- fillTree(C1) ('bim' variable = impact parameter)
- current statistics: ~233.1 M events (~1 M or ~100 K events per final merged ROOT file, see below) - **RUNNING**
- output files for this production are in: /scratch7/abilandz/sim/EPOS_20221228 
  ...
  - subdirectories 155-935 have ~100 K events per final merged ROOT file (additional production) - **RUNNING**
